			...
			<div class="row main">
				<div class="panel-heading">
	               <div class="panel-title text-center">
	               		<h1 class="title" style="color: #fff;">Cadastro Taxista</h1>
	               		<hr />
	               	</div>
	            </div> 
				<div class="main-login main-center">
					<form class="form-horizontal" method="post" action="model.php">
						...
						<div class="form-group">
							...
							<div class="cols-sm-10">
								<div class="input-group">
									...
									<input type="text" class="form-control" name="nome" id="name"  placeholder="Enter your Name"/>
								</div>
							</div>
						</div>
						...
						<div class="form-group ">
							<input type="submit" name="cad" value="Registrar" class="btn btn-primary btn-lg btn-block login-button">Registrar</input>
						</div>
